 ...
 */
class NewslettterRepository extends ServiceEntityRepository
{
...
//    /**
//     * @return Newslettter[] Returns an array of Newslettter objects
//     */
...
//    public function findOneBySomeField($value): ?Newslettter
//    {
//        return $this->createQueryBuilder('n')
//            ->andWhere('n.exampleField = :val')
//            ->setParameter('val', $value)
